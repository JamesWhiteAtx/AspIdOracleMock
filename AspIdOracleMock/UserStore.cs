...
namespace Asp.Identity.Oracle
{
        ...
        where TUser : IdentityUser
    {
        ...
        private Task<TUser> GetUserAggregateAsync(Expression<Func<TUser, bool>> filter)
        {
            ...
            IdentityUser u = Users.FirstOrDefault(filter);
            return Task<TUser>.FromResult(u as TUser);
        }
        ...
        public IQueryable<TUser> Users
        {
            ...
            get {
                IQueryable<IdentityUser> q = Context.Users.AsQueryable();
                return (IQueryable<TUser>)q;
            }
        }
